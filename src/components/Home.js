      ...
      <div className="d-none d-lg-flex align-items-center position-relative" style={{ height: "100vh" }}>
        ...
        <div className="col-12 col-lg-5 d-flex flex-column align-items-center justify-content-center px-4">
          ...
          <div className="text-center">
            <h2 className="mb-3" style={{fontSize: "2.5rem !important"}}>Hi! I am Gokul</h2>
            <h1 className="mt-2" style={{fontSize: "2.5rem !important"}}>I am a {text}</h1>
          </div>
        </div>
        ...
        <div className="position-absolute end-0 d-flex align-items-center justify-content-center " style={{ width: "50%", height: "100vh" }}>
          <div className="p-4 d-flex flex-column justify-content-start" style={{ backgroundColor: "#ffffff", boxShadow: "4px 4px 15px rgba(0, 0, 0, 0.1)",  maxWidth: "100%", height: "40vh", overflowY: "auto", marginTop: "10vh" }}>
              <h1 className="mb-4 text-center" style={{fontFamily: "'Rajdhani', 'sans-serif'", color: '#333', fontSize: '2rem !important'}}>ABOUT ME</h1>
              <p style={{fontFamily: "'Rajdhani', 'sans-serif'", fontSize: '1.1rem !important', color: '#333', lineHeight: "1.6"}} className='text-wrap'>
