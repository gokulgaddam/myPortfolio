      ...
      <div className="position-relative">
        ...
        <div className="row mb-5">
            ...
            <div className="card shadow-lg border-2" style={{ backgroundColor: "#ffffff", borderRadius: "12px", minHeight: "200px" }}>
              <div className="card-body p-5">
                <div className="d-flex justify-content-between align-items-start mb-4">
                  <h3 className="card-title text-primary mb-0" style={{ fontSize: '1.8rem' }}>Software Engineer – ReactNative</h3>
                  <span className="badge bg-primary" style={{ fontSize: '1rem' }}>Current</span>
                </div>
                <h5 className="text-muted mb-3" style={{ fontSize: '1.3rem' }}>CrowdDoing</h5>
                <p className="text-muted mb-3" style={{ fontSize: '1.1rem' }}>Mar 2025 – Present</p>
                <p className="card-text" style={{ fontSize: '1.2rem', lineHeight: "1.7" }}>
          ...
          <div className="col-2 d-none d-md-flex justify-content-center align-items-center">
            <div className="rounded-circle bg-white border border-3 border-primary" style={{
              width: '20px',
              height: '20px',
              zIndex: 2,
              position: 'relative'
        ...
        <div className="row mb-5">
          ...
          <div className="col-12 col-md-5 ps-md-4">
            <div className="card shadow-lg border-2" style={{ backgroundColor: "#ffffff", borderRadius: "12px", minHeight: "200px" }}>
              <div className="card-body p-5">
                <h3 className="card-title text-primary mb-4" style={{ fontSize: '1.8rem' }}>Graduate Teaching Assistant – Web Development</h3>
                <h5 className="text-muted mb-3" style={{ fontSize: '1.3rem' }}>George Mason University</h5>
        ...
        <div className="row mb-5">
          ...
          <div className="col-12 col-md-5 pe-md-4">
            <div className="card shadow-lg border-2" style={{ backgroundColor: "#ffffff", borderRadius: "12px", minHeight: "280px" }}>
              <div className="card-body p-5">
                <h3 className="card-title text-primary mb-4" style={{ fontSize: '1.8rem' }}>Associate Software Engineer – Full Stack</h3>
                <h5 className="text-muted mb-3" style={{ fontSize: '1.3rem' }}>Accenture Solutions Pvt. Ltd.</h5>
        ...
        <div className="row mb-5">
          ...
          <div className="col-12 col-md-5 ps-md-4">
            <div className="card shadow-lg border-2" style={{ backgroundColor: "#ffffff", borderRadius: "12px", minHeight: "240px" }}>
              <div className="card-body p-5">
                <h3 className="card-title text-primary mb-4" style={{ fontSize: '1.8rem' }}>Software Developer – Full Stack</h3>
                <h5 className="text-muted mb-3" style={{ fontSize: '1.3rem' }}>Kalpas Innovations Pvt. Ltd.</h5>
